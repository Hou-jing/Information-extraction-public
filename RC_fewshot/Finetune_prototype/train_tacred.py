...
from model_rel_pro import REModel
...
def main():
    ...
    parser.add_argument("--data_dir", default="E:/PythonProject/pythonProject_22.10.24_few_shot/小样本想法/dataset/tacred", type=str)
    ...
    parser.add_argument("--project_name", type=str, default="few-shot-for-re—relemb-tacred")
    parser.add_argument("--run_name", type=str, default="tacred")
    parser.add_argument('--temps',type=str,default='new_temp.txt')
    parser.add_argument('--train_file',type=str,default='k-shot/16-4/train.txt')
    parser.add_argument('--prop', type=str, default='sent_averg')
    ...
    dev_file = os.path.join(args.data_dir, "val.txt")
