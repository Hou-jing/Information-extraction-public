...
def main():
    ...
    parser.add_argument("--data_dir", default="E:/PythonProject/pythonProject_22.10.24_few_shot/小样本想法/dataset/retacred", type=str)
    ...
    parser.add_argument("--project_name", type=str, default="few-shot-for-re—relemb-retacred")
    ...
    train_file = os.path.join(args.data_dir, "k-shot/16-1/train.txt")
